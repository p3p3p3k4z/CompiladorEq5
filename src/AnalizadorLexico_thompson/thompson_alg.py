...
# Paso 1: Obtener la ruta absoluta de la carpeta, .. niveles folder, nombre folder
lib_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'AnalizadorLexico_generales'))

# Paso 2: Añadir 'lib' al sys.path para poder importar sus módulos
sys.path.append(lib_path)

# Ahora puedes importar los módulos de la carpeta
import lista_enlazada
import automata_transicion
import automata_estado
