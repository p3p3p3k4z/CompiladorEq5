...
lib_path2 = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'Analisis_Sintactico'))
sys.path.append(lib_path2)

from Primeros_Siguientes import CargarGramatica, Primero, Siguientes
...
def ventanita():    # Configuración de la ventana
