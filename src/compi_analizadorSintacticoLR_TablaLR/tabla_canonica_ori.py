...
def maint():
    """
    Programa principal que utiliza una ruta predefinida para procesar la gramática.
    """
    ruta_archivo = r"Gramatica1.txt"  # Cambia esto según la ubicación real del archivo
